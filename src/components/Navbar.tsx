...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-white dark:bg-gray-800 bg-opacity-90 backdrop-blur-lg rounded-full px-4 py-2 shadow-lg w-11/12 max-w-4xl z-50">
